...
camera_name = "AGX_Cam_01"
commands_topic = "commands/{}".format(camera_name)
processed_commands_topic = "processedcommands/{}".format(camera_name)
...
def on_message(client, userdata, msg):
    if msg.topic == processed_commands_topic:
        ...
        if payload_string.count(CMD_TAKE_PICTURE) > 0:
...
if __name__ == "__main__":
    ...
    publish_command(client, CMD_TAKE_PICTURE, KEY_RESOLUTION, (1080, 720))
